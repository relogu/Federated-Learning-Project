...
wait
python3 scripts/plot_metrics.py --prefix=EUROMDS-rrrr_ude2k1u4k --in_folder="$PWD/output1" 
sleep 10
...
trap "trap - SIGTERM && kill -- -$$" SIGINT SIGTERM EXIT;
wait
python3 scripts/plot_metrics.py --prefix=EUROMDS-rrr_ude2k1u4k --in_folder="$PWD/output1"
sleep 10
...
trap "trap - SIGTERM && kill -- -$$" SIGINT SIGTERM EXIT;
wait
python3 scripts/plot_metrics.py --prefix=EUROMDS-rr_ude2k1u4k --in_folder="$PWD/output1"
sleep 10
...
trap "trap - SIGTERM && kill -- -$$" SIGINT SIGTERM EXIT;
wait
python3 scripts/plot_metrics.py --prefix=EUROMDS-r_ude2k1u4k --in_folder="$PWD/output1"
sleep 10
...
trap "trap - SIGTERM && kill -- -$$" SIGINT SIGTERM EXIT;
wait
python3 scripts/plot_metrics.py --prefix=EUROMDS_ude2k1u4k --in_folder="$PWD/output1"
sleep 10
