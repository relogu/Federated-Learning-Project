...
In this simulation the unsupervised deep embedding for clustering is used on the EUROMDS dataset reduced, i.e. without 'Demographics', 'Clinical', 'GeneGene', 'CytoCyto', 'GeneCyto' columns.
