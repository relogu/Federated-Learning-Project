...
In the very first simulation, different FL settset ups are compared with the aggregated one.
...
performed at clients' places, are chosen to increase as the number of clients does, i.e. 1,2,2,3,3,4,5 
...
is transformed using the rotation or the traslation transformation defined above.
...
More the FL set up is distributed, slower is the convergence, as Fig.\ref{} shows.
