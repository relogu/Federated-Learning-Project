...
from . import compute_centroid_np, return_not_binary_indices
from losses import get_keras_loss
from parsers import dec_euromds_parser
...
if __name__ == "__main__":
    # configuration
    # get parameters
    args = dec_euromds_parser().parse_args()
    ...
    config['ae_metrics'] = [
        ...
        my_metrics.get_slice_hamming_loss(
            mode='multilabel', threshold=0.50, idx=b_idx),
