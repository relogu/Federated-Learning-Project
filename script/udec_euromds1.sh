...
# entire dataset
python3 py/udec/main.py --n_clusters 8 --tied --groups Genetics --groups CNA --ex_col UTX --ex_col CSF3R --ex_col SETBP1 --ex_col PPM1D  --folder "$PWD/output_udec1" --hardware_acc
wait
sleep 5
