...
python3 clustering/py/client_euromds.py --verbose --n_clusters 8 --ran_flip 0.25 --server=[::]:51552 --update_interval 100 --n_clients=6 --tied --client_id=0 --groups=Genetics --groups=CNA --ex_col UTX --ex_col CSF3R --ex_col SETBP1 --ex_col PPM1D --out_fol="$PWD/output_fed_udec2" &
python3 clustering/py/client_euromds.py --verbose --n_clusters 8 --ran_flip 0.25 --server=[::]:51552 --update_interval 100 --n_clients=6 --tied --client_id=1 --groups=Genetics --groups=CNA --ex_col UTX --ex_col CSF3R --ex_col SETBP1 --ex_col PPM1D --out_fol="$PWD/output_fed_udec2" &
python3 clustering/py/client_euromds.py --verbose --n_clusters 8 --ran_flip 0.25 --server=[::]:51552 --update_interval 100 --n_clients=6 --tied --client_id=2 --groups=Genetics --groups=CNA --ex_col UTX --ex_col CSF3R --ex_col SETBP1 --ex_col PPM1D --out_fol="$PWD/output_fed_udec2" &
python3 clustering/py/client_euromds.py --verbose --n_clusters 8 --ran_flip 0.25 --server=[::]:51552 --update_interval 100 --n_clients=6 --tied --client_id=3 --groups=Genetics --groups=CNA --ex_col UTX --ex_col CSF3R --ex_col SETBP1 --ex_col PPM1D --out_fol="$PWD/output_fed_udec2" &
python3 clustering/py/client_euromds.py --verbose --n_clusters 8 --ran_flip 0.25 --server=[::]:51552 --update_interval 100 --n_clients=6 --tied --client_id=4 --groups=Genetics --groups=CNA --ex_col UTX --ex_col CSF3R --ex_col SETBP1 --ex_col PPM1D --out_fol="$PWD/output_fed_udec2" &
python3 clustering/py/client_euromds.py --verbose --n_clusters 8 --ran_flip 0.25 --server=[::]:51552 --update_interval 100 --n_clients=6 --tied --client_id=5 --groups=Genetics --groups=CNA --ex_col UTX --ex_col CSF3R --ex_col SETBP1 --ex_col PPM1D --out_fol="$PWD/output_fed_udec2" &
