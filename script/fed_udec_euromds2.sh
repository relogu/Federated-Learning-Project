...
# UDEC using EUROMDS
python3 clustering/py/server.py --n_clusters 8 --address=[::]:51552 --strategy=k-fed --kmeans_epochs=1 --ae_epochs=10000 --cluster_epochs=10000 --n_clients=6 --out_fol="$PWD/output_fed_udec2" & 
...
wait
mkdir "$PWD/results/8kFED_ui6CEUROMDSfinal_deno_ude10k1u10k"
mv "$PWD/output_fed_udec2/"/* "$PWD/results/8kFED_ui6CEUROMDSfinal_deno_ude10k1u10k"/
