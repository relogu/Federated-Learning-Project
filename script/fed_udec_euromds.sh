...
# UDEC using EUROMDS
python3 clustering/py/server.py --address=[::]:51550 --n_clusters 8 --strategy=k-fed --kmeans_epochs=1 --ae_epochs=2000 --cluster_epochs=10000 --n_clients=2 --out_fol="$PWD/output_fed_udec" & 
