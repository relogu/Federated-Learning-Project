...
python3 clustering/py/client_euromds.py --verbose --cuda --n_clusters 8 --ran_flip 0.25 --server=[::]:51550 --update_interval 100 --n_clients=2 --tied --client_id=0 --groups=Genetics --groups=CNA --ex_col UTX --ex_col CSF3R --ex_col SETBP1 --ex_col PPM1D --out_fol="$PWD/output_fed_udec" &
python3 clustering/py/client_euromds.py --verbose --cuda --n_clusters 8 --ran_flip 0.25 --server=[::]:51550 --update_interval 100 --n_clients=2 --tied --client_id=1 --groups=Genetics --groups=CNA --ex_col UTX --ex_col CSF3R --ex_col SETBP1 --ex_col PPM1D --out_fol="$PWD/output_fed_udec" &
