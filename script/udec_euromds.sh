...
# entire dataset
python3 py/udec/main.py --groups Genetics --groups CNA --ex_col UTX --ex_col CSF3R --ex_col SETBP1 --ex_col PPM1D --n_clusters=6 --ae_epochs=20000 --cl_epochs=10000 --folder="$PWD/output_udec" --binary
wait
