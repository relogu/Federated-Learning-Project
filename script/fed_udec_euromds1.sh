...
mkdir "$PWD/output_fed_udec1"
# UDEC using EUROMDS
python3 clustering/py/server.py --address=[::]:51551 --n_clusters 8 --strategy=k-fed --kmeans_epochs=1 --ae_epochs=2000 --cluster_epochs=10000 --n_clients=4 --out_fol="$PWD/output_fed_udec1" & 
sleep 2 # Sleep for 2s to give the server enough time to start
