...
sleep 2 # Sleep for 2s to give the server enough time to start
python3 clustering/py/client_euromds.py --u_norm --verbose --n_clusters 8 --ran_flip 0.25 --server=[::]:51551 --update_interval 100 --n_clients=4 --tied --client_id=0 --groups=Genetics --groups=CNA --ex_col UTX --ex_col CSF3R --ex_col SETBP1 --ex_col PPM1D --out_fol="$PWD/output_fed_udec1" &
python3 clustering/py/client_euromds.py --u_norm --verbose --n_clusters 8 --ran_flip 0.25 --server=[::]:51551 --update_interval 100 --n_clients=4 --tied --client_id=1 --groups=Genetics --groups=CNA --ex_col UTX --ex_col CSF3R --ex_col SETBP1 --ex_col PPM1D --out_fol="$PWD/output_fed_udec1" &
python3 clustering/py/client_euromds.py --u_norm --verbose --n_clusters 8 --ran_flip 0.25 --server=[::]:51551 --update_interval 100 --n_clients=4 --tied --client_id=2 --groups=Genetics --groups=CNA --ex_col UTX --ex_col CSF3R --ex_col SETBP1 --ex_col PPM1D --out_fol="$PWD/output_fed_udec1" &
python3 clustering/py/client_euromds.py --u_norm --verbose --n_clusters 8 --ran_flip 0.25 --server=[::]:51551 --update_interval 100 --n_clients=4 --tied --client_id=3 --groups=Genetics --groups=CNA --ex_col UTX --ex_col CSF3R --ex_col SETBP1 --ex_col PPM1D --out_fol="$PWD/output_fed_udec1" &
