...
python3 clustering/py/client_euromds.py --server=[::]:51552 --client_id=0 --alg=clustergan --fold_n=0 --n_clients=8 --groups=1 --n_clusters=6 --out_fol="$PWD/output2" &
python3 clustering/py/client_euromds.py --server=[::]:51552 --client_id=1 --alg=clustergan --fold_n=0 --n_clients=8 --groups=1 --n_clusters=6 --out_fol="$PWD/output2" &
python3 clustering/py/client_euromds.py --server=[::]:51552 --client_id=2 --alg=clustergan --fold_n=0 --n_clients=8 --groups=1 --n_clusters=6 --out_fol="$PWD/output2" &
python3 clustering/py/client_euromds.py --server=[::]:51552 --client_id=3 --alg=clustergan --fold_n=0 --n_clients=8 --groups=1 --n_clusters=6 --out_fol="$PWD/output2" &
python3 clustering/py/client_euromds.py --server=[::]:51552 --client_id=4 --alg=clustergan --fold_n=0 --n_clients=8 --groups=1 --n_clusters=6 --out_fol="$PWD/output2" &
python3 clustering/py/client_euromds.py --server=[::]:51552 --client_id=5 --alg=clustergan --fold_n=0 --n_clients=8 --groups=1 --n_clusters=6 --out_fol="$PWD/output2" &
python3 clustering/py/client_euromds.py --server=[::]:51552 --client_id=6 --alg=clustergan --fold_n=0 --n_clients=8 --groups=1 --n_clusters=6 --out_fol="$PWD/output2" &
python3 clustering/py/client_euromds.py --server=[::]:51552 --client_id=7 --alg=clustergan --fold_n=0 --n_clients=8 --groups=1 --n_clusters=6 --out_fol="$PWD/output2" &
