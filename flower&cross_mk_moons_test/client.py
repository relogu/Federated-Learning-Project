...
def parse_args():
    ...
    parser.add_argument('--test',
                        ...
                        type=bool,
                        action='store',
                        help='tells the program whether to evaluate also on totally new data')
...
if __name__ == "__main__":
    ...
    def get_train_set(f_round):
        """Return the index for the train dataset, given the federated iteration."""
        index = (f_round-1)%n_splits
        i=0
    ...
    def get_test_set(f_round):
        """Return the index for the test dataset, given the federated iteration."""
        index = (f_round-1)%n_splits
        i=0
    ...
    class MakeMoonsClient(fl.client.NumPyClient):
        ...
        def fit(self, parameters, config):  # type: ignore
            ...
            train, test = get_index_by_fold(args.client_id)
        ...
        def evaluate(self, parameters, config):  # type: ignore
            ...
            if self.f_round%100 == 0 and PLOT:
                ...
                if TEST:
                    ...
                    plot_decision_boundary(model, 'NEW', x_test, y_test)
            else :
